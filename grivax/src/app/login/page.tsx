...
import FormWithReCaptcha from "@/components/ReCaptchaElement"
      ...
      <div className="flex w-full flex-col justify-between p-4 sm:p-6 md:p-8 lg:w-1/2 lg:p-12">
        ...
        <div className="mx-auto mt-4 w-full max-w-md sm:mt-6 md:mt-8">
          <div className="space-y-2 text-center">
            ...
            <p className="text-sm text-muted-foreground sm:text-base">Enter your credentials to access your account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4 sm:mt-8 sm:space-y-6">
            ...
            {/* <div className="rounded-md border border-border bg-muted/30 p-2 sm:p-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2 sm:space-x-3">
                  <div className="h-4 w-4 rounded border border-border sm:h-5 sm:w-5"></div>
