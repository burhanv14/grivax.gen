interface PlaceholderImageProps {
  ...
  export default function PlaceholderImage({ width, height, alt, className }: PlaceholderImageProps) {
    ...
    return (
      <div
        className={`relative flex items-center justify-center bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-800 dark:to-gray-900 overflow-hidden ${className || ""}`}
        style={{ width, height }}
      >
        <svg
